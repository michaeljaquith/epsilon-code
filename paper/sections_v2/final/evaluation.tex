...
run across four models (GPT-4o-2024-08-06, GPT-4o-mini, GPT-4-turbo,
DeepSeek V3) with \texttt{logprobs=True, top\_logprobs=5},
...
Pydantic), run on four models. GPT-4o and DeepSeek V3 both achieve
$85\%$ HIGH detection; GPT-4o-mini and GPT-4-turbo both achieve $70\%$.
DeepSeek V3 carries a higher LOW FP rate ($70\%$) than the OpenAI
models, consistent with its larger vocabulary of naming alternatives.
