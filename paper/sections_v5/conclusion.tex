...
zero observed misses, at precision $0.272$. The function-%
...
$10.5\%$ exceed the flag threshold. A reviewer given \eps's output
is not asked to re-read $98$ tokens; they are asked to evaluate the
$\sim 10$ tokens that cross the flag threshold --- an $89\%$
